...
public static class ReflectionHelper
{
    ...
    {
        return Object.GetType().GetField(Property, ReflectionHelper.MemberAccess | BindingFlags.GetField).GetValue(Object);
    }
    ...
    public static List<KeyValuePair<string, string>> GetEnumList(Type enumType, bool valueAsFieldValueNumber = false)
    {
        ...
        foreach (var enumValue in enumValues)
        {
            ...
            if (!valueAsFieldValueNumber)
                items.Add(new KeyValuePair<string, string>(enumValue.ToString(), StringHelper.FromCamelCase(strValue)));
            else
                items.Add(new KeyValuePair<string, string>(((int)enumValue).ToString(),
                    StringHelper.FromCamelCase(strValue)
                ));
        }
        return items;
    }
    ...
    {
        return instance.GetType().InvokeMember(property, ReflectionHelper.MemberAccessCom | BindingFlags.GetProperty, null,
                                            instance, null);
    }
    ...
    public static object GetPropertyExCom(object parent, string property)
    {
        ...
        if (lnAt < 0)
        {
            ...
            // Get the member
            return parent.GetType().InvokeMember(property, ReflectionHelper.MemberAccessCom | BindingFlags.GetProperty, null,
                parent, null);
        }
        ...
        object Sub = parent.GetType().InvokeMember(Main, ReflectionHelper.MemberAccessCom | BindingFlags.GetProperty, null,
            parent, null);
    ...
    {
        inst.GetType().InvokeMember(Property, ReflectionHelper.MemberAccessCom | BindingFlags.SetProperty, null, inst, new object[1] { Value });
    }
    ...
    public static object SetPropertyExCom(object parent, string property, object value)
    {
        ...
        {
            // Set the member
            parent.GetType().InvokeMember(property, ReflectionHelper.MemberAccessCom | BindingFlags.SetProperty, null,
    ...
    {
        return instance.GetType().InvokeMember(method, ReflectionHelper.MemberAccessCom | BindingFlags.InvokeMethod, null, instance, parms);
    }
    ...
    public static object CallMethodExCom(object parent, string method, params object[] parms)
    {
        ...
        if (at < 0)
        {
            return ReflectionHelper.CallMethodCom(parent, method, parms);
        }
